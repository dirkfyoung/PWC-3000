Public Class Standard
    ...
    Public Const VersionNumber As String = "3.0020"
    ...
    Public Const sprayterm2 As String = "Aerial (F-M) EPA Default"
    ...
    Public Const sprayterm7 As String = "Ground (Low Boom, VF-F)"
    Public Const sprayterm8 As String = "Ground (Low Boom, F-MC)"

    Public Const sprayterm9 As String = "Airblast (normal)"
    Public Const sprayterm10 As String = "Airblast (dense)"
    Public Const sprayterm11 As String = "Airblast (sparse) EPA Default"
