module utilities_1
    ...
    character(LEN=25) :: schemnumber, scenarionumber
    ...
    run_ID =  trim(adjustl(schemnumber)) // '_' // trim(adjustl(scenarionumber)) // '_' // trim(adjustl(scenario_names(i,j)((last_slash+1):(last_dot-1))))
