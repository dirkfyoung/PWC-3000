...
subroutine solute_holding_capacity(koc)
   use constants_and_variables, ONLY: echofileunit, benthic_depth, porosity,bulk_density,FROC2,DOC2,BNMAS,SUSED,FROC1,DOC1,PLMAS, area_waterbody,depth_0
