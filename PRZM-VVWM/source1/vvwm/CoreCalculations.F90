...
use constants_and_variables, ONLY: echofileunit, num_records, benthic_depth, porosity, area_waterbody, DELT_vvwm
    use noninputvariables, ONLY: A,B,E,F, m1_input,m1_store,m2_store,mavg1_store, &
                                 daily_depth,fw1,fw2,       &
