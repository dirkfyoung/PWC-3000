...
subroutine photolysis (nchem)
   ...
   !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    use constants_and_variables, ONLY: num_records, temp_avg, latitude, photo_rate, RFLAT, sused, dfac, chl,DOC1,CLOUD
    
    use nonInputVariables, Only: daily_depth,k_photo  !output photolysi rate (per sec)
    implicit none
...
subroutine hydrolysis(nchem)
  ...
  use constants_and_variables, ONLY: hydrolysis_rate, minimum_depth
...
subroutine metabolism (nchem)
  ...
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    use constants_and_variables, ONLY: EchoFileUnit, temp_avg , water_column_rate, benthic_rate,water_column_ref_temp ,benthic_ref_temp, Q_10
...
use constants_and_variables, ONLY: num_records, temp_avg, wind_m , mwt, henry_unitless,heat_of_henry, area_waterbody, wind_height 
 
use nonInputVariables, Only: k_volatile,  &     !output: effective first-order decay rate due to volatilization
